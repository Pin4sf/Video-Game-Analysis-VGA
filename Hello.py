...
st.markdown(
    '''
    [![VGA.gif](https://i.postimg.cc/C5f8tMm5/VGA.gif)](https://postimg.cc/PvTNvHGn)
    '''
)
...
st.markdown(
    ...
    **👈 Select a App from the sidebar** to explore my findings 
    ...
    [![Typing SVG](https://readme-typing-svg.herokuapp.com?font=Ubuntu+Mono&weight=500&size=24&duration=4000&pause=500&color=EF58E1&background=FF45ED00&center=true&vCenter=true&width=600&lines=Pandas+for+Data+Analysis;Numpy+for+mathematical+computing;Matplotlib+And+Seaborn+for+Data+Visualisation;Scikitlearn+for+Machine+Learning)](https://git.io/typing-svg)
